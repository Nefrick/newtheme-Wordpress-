...
class TutsPlus_Post_Notice_Editor {
    ...
    public function post_notice_display(){
        require_once( plugin_dir_path(__FILE__ ) . 'assets/views/tutsplus-post-notice-editor.php' );
    }
    ...
    public function user_can_save( $post_id ){
        ...
        $is_valid_nonce =
        ( isset( $_POST['tutsplus-post-notice-nonce'] ) ) && wp_verify_nonce(
            $_POST['tutsplus-post-notice-nonce'], 'tutsplus-post-notice-save'
        );
